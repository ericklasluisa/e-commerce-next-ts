...
const Page = () => {
  ...
  const addQuantityItems = (id: number) => {
    setSelectedProducts([...selectedProducts, id]);
  };

  const removeQuantityItems = (id: number) => {
    const pos = selectedProducts.indexOf(id);
  
    if (pos !== -1) {
      const updatedProducts = selectedProducts.filter((value, index) => index !== pos);
                    ...
                    <li key={product.id}>
                      <div className="flex my-4 items-center border rounded p-4">
                        ...
                        <div className="ml-8">
                          ...
                          <p className="text-lg">
                            ${" "}
                            <span className="font-bold text-md my-4">
                              {product.price}
                            </span>
                          </p>
                      ...
                      <li key={product.id}>
                        <div>
                          ...
                          <div className="flex items-center space-x-4 my-2">
                            ...
                            <p className="text-md">
                              $
                              <span className="ml-2 font-semibold text-md my-2">
                                {product.price}
                              </span>
                            </p>
                          </div>
