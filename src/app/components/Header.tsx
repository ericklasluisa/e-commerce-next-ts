...
const Header = () => {
  ...
  const { selectedProducts } = useContext(ProductContext) as {
      ...
      <div className="grid sm:grid-rows-1">
        <div className="flex items-center min-w-screen px-8 pt-4 bg-sky-700 text-white">
          ...
          >
            ...
            <button
              type="submit"
              className="bg-sky-950 rounded-r border-r border-y border-slate-900 py-1 px-4
          ...
          <div className="flex items-center space-x-8 text-xl mx-4 z-10">
            <div className="relative">
              ...
              <div className="absolute right-0" onClick={handleClick}>
                {bell && <Notification />}
              </div>
            </div>
            ...
            <div className="flex relative">
              ...
              <p className="text-sky-950 absolute top-0 right-1">
